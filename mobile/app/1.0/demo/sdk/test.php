...
<div class="navbar navbar-inverse">
	...
	<p><a class="btn btn-primary" onclick="Host.open('http://www.taobao.com')" href="javascript:void(0)">打开一个url(http://www.taobao.com)</a></p>
	<p><a class="btn btn-primary" onclick="Host.open('b.php')" href="javascript:void(0)">打开相对路径url(a.php)</a></p>
