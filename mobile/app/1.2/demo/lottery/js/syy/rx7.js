...
KISSY.add("mobile/app/1.2/demo/lottery/js/syy/rx7" , function (S , Tool , Layout , Ball , BackboneLocalstorage, _) {
		...
		return {
			...
			setbar: function(){
				...
				this.$el.find('.return').attr({
					...
					'data-param': 'lotype=syy&subtype=rx7',
					dir: 'back'
				});
	...
	return {
		initialize: function(isEdit){
			...
			C.syyrx7ballapp = new Ball.App(appConfig(isEdit,C.syyrx7ballcollection));
			this.setType(isEdit);
		},
