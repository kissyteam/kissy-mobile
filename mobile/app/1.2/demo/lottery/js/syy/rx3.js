...
KISSY.add("mobile/app/1.2/demo/lottery/js/syy/rx3" , function (S , Tool , Layout , Ball , BackboneLocalstorage , _) {
		...
		return {
			...
			setbar: function(){
				...
				this.$el.find('.return').attr({
					...
					'data-param': 'lotype=syy&subtype=rx3',
					dir: 'back'
				});
	...
	return {
		initialize: function(isEdit){
			...
			C.syyrx3ballapp = new Ball.App(appConfig(isEdit,C.syyrx3ballcollection));
			this.setType(isEdit);
		},
