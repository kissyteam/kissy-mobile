...
KISSY.add("mobile/app/1.2/demo/lottery/js/base/tool", function(S , Confirm , _) {
	var tool = {
		/**
		 * 组合算法
		 * @name C
	...
	requires: [ 'mobile/app/1.2/demo/lottery/js/widget/confirm/confirm' , 'mobile/app/1.2/demo/lottery/js/lib/underscore'],
});
