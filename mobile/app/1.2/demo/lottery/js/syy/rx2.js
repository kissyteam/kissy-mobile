...
KISSY.add("mobile/app/1.2/demo/lottery/js/syy/rx2" , function (S , Tool , Layout , Ball , BackboneLocalstorage , _) {
		...
		return {
			...
			setbar: function(){
				...
				this.$el.find('.return').attr({
					...
					'data-param': 'lotype=syy&subtype=rx2',
					dir: 'back'
				});
	...
	return {
		initialize: function(isEdit){
			...
			C.syyrx2ballapp = new Ball.App(appConfig(isEdit,C.syyrx2ballcollection));
			this.setType(isEdit);
		},
