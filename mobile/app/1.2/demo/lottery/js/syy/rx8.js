...
KISSY.add("mobile/app/1.2/demo/lottery/js/syy/rx8" , function (S , Tool , Layout , Ball , BackboneLocalstorage , _) {
		...
		return {
			...
			setbar: function(){
				...
				this.$el.find('.return').attr({
					...
					'data-param': 'lotype=syy&subtype=rx8',
					dir: 'back'
				});
	...
	return {
		initialize: function(isEdit){
			...
			C.syyrx8ballapp = new Ball.App(appConfig(isEdit,C.syyrx8ballcollection));
			this.setType(isEdit);
		},
